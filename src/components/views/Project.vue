...
<template>
    <main class="conteiner-fluid d-flex flex-column justify-content-center align-items-center mb-5">
                ...
                <div class="container">
                    <div class="row flex-column flex-md-row">
                        <div class="col d-flex flex-column justify-content-center">
                            <h3 class="h3 mb-5"><strong>The multiverse of metaverses you have been waiting for.</strong>
                            </h3>
                            <p class="lead">The platform and framework based on GODOT engine and Multi Analysis PrObe Drone
                                to
                                create metaverses for Anthropology, Archaeology and Cultural Heritage.</p>
                            <p class="lead">
                                Project based on an idea of Roberto Taglioretti with the contributions of this community and
                                built
                                using FLOSS.
                            </p>
                        </div>
        ...
        <section class="container-fluid">
            <article class="container my-3" style="max-width: 1200px">
                <div class="container">
                    <h3 class="h3 mb-5"><strong>Softwares, programming languages and tools used to build MAPOD4D</strong>
                    </h3>
                    <div class="d-flex fl align-items-center gap-5 ">
                    ...
                    <div class="d-flex fl align-items-center gap-5 ">
                        ...
                        <p class="lead">Blender <a href="https://www.blender.org" target="_blank">website</a></p>
                    </div>
                    <div class="d-flex fl align-items-center gap-5 ">
                    ...
                    <div class="d-flex fl align-items-center gap-5 ">
                        <img src="./img/null.png" alt="no logo" width="50" height="50">
                        <p class="lead">GNU/Linux <a href="https://kernel.org/" target="_blank">website</a></p>
                    </div>
                    <div class="d-flex fl align-items-center gap-5 ">
                        <img src="./img/null.png" alt="no logo" width="50" height="50">
                    ...
                    <div class="d-flex fl align-items-center gap-5 ">
                        <img src="./img/null.png" alt="no logo" width="50" height="50">
                        <p class="lead">Django REST <a href="https://www.django-rest-framework.org/"
                    ...
                    <div class="d-flex fl align-items-center gap-5 ">
                        <img src="./img/null.png" alt="no logo" width="50" height="50">
                        <p class="lead">Bootstrap <a href="https://getbootstrap.com/" target="_blank">website</a></p>
                    </div>
                    <div class="d-flex fl align-items-center gap-5 ">
                        <img src="./img/null.png" alt="no logo" width="50" height="50">
